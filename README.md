* 보수 필요한 사항: 경력에 팀과 직급 기입. 자격항목 발행처 명시. 포트폴리오 최신화(경력기술서 보완)
...
- [(주)에이아이파크](https://app.aivatar.ai) - 프론트엔드 개발
  - 2024.03 ~ 2025.02
  - AI 아바타 생성 서비스 AIVATAR의 추가개발 및 유지보수를 진행했습니다.
  - 프로덕트에 존재하는 핵심 버그들을 수정하며, typescript와 eslint를 도입 후 리팩토링을 진행했습니다.
  - i18n 마이그레이션을 진행하였으며, 이를 효율적으로 사용하기 위한 eslint룰을 개발했습니다.
  - 여러가지 요구사항을 대응하면서, git flow 각각의 쓰임새를 더욱 체감할 수 있는 좋은 경험을 만들어갔습니다.

- [(주)바이트컴퍼니](https://www.mydailybyte.com) - 프론트엔드 개발
  - 2022.08 ~ 2023.11
  - 미디어 플랫폼 데일리바이트의 웹 프론트엔드 개발을 전담했습니다. 또한 B2B 서비스로, 신한금융투자, 농협 올원뱅크 앱에 웹뷰를 공급했습니다.
  - 자체 웹 사이트를 신규 구축한 후 여러 구독자 유입 촉진 프로그램 개발에 참여한 결과, 구독자 수가 30,000명(약 100%) 증가하게 되었습니다.
